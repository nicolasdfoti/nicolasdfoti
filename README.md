...
**💻 Core stack**
`Python` | `n8n` | `Power Automate / Power Apps` | `SQL` | `FastAPI` | `React / Next.js` | `TypeScript` | `C#`

**🧠 Currently deepening**
`AWS (Cloud Practitioner)` | `LLM & AI integration` | `Databases & Cloud Services` | `Docker`
...
Data & Automation Analyst | AI Automation Engineer | Business Process Automation

**🌱 A bit more about me**
- English instructor for international students
